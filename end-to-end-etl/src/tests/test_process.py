...
from end_to_end.process import (
    process_vehicles, process_operating_periods, process_events, _convert_datetime_to_utc
)
...
def records():
    return [
        {'event': 'create', 'on': 'operating_period', 'at': '2023-06-01T08:00:00.000Z',
         'data': {'id': 'op_123', 'start': '2023-06-01T08:15:00.000Z', 'finish': '2023-06-01T08:30:00.000Z'},
         'organization_id': 'org-1'},

        {'event': 'register', 'on': 'vehicle', 'at': '2023-06-01T08:10:00.000Z',
            'data': {'id': 'veh_123'},
            'organization_id': 'org-1'},

        {'event': 'update', 'on': 'vehicle', 'at': '2023-06-01T08:20:00.000Z', 'data':
            {'id': 'veh_456', 'location':
                {'lat': 52, 'lng': 13, 'at': '2023-06-01T08:20:00.000Z'}},
            'organization_id': 'org-1'}
    ]
...
def test_process_operating_periods(records):
    for record in records:
        if record['on'] == 'operating_period':
            ...
            assert result == (
                'op_123', '2023-06-01T08:15:00.000Z', '2023-06-01T08:30:00.000Z')
