...
class Loader:
    def __init__(self, host: str, user: str, passwd: str, db: str) -> None:
        """
        Initialize the Loader object and establish
        the connection to the database.
        """
        self.connection = self._create_connection(host, user, passwd, db)

    def _create_connection(
        self, host: str, user: str, passwd: str, db: str, port: int = 3306
        ...
        try:
            connection = mysql.connector.connect(
                host=host, user=user, port=port, passwd=passwd, database=db
            )
    ...
    def insert_data(self, table_name: str, columns: str, data: Tuple) -> None:
        ...
        Args:
            ...
            columns: Comma-separated names where data should be inserted.
